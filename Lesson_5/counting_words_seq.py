...
def word_count():
    ...
    for line in sys.stdin:
        ...
        for word in data:
           ...
           if new_word.lower() in word_counts:
               word_counts[new_word.lower()] += 1
           else:
               word_counts[new_word.lower()] = 1
...
# to run from command line echo "asdfsdaf asdfsdf fdfsa fds" | python .\Lesson_5\counting_words_seq.py